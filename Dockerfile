...
RUN cd /tmp && \
    ...
    echo "upload_max_filesize=1024M" >> /usr/local/etc/php/conf.d/upload-max-filesize.ini && \
    echo "post_max_size=1024M" >> /usr/local/etc/php/conf.d/upload-max-filesize.ini
